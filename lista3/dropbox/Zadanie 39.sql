-- Zadanie 39
-- Napisać blok PL/SQL wczytujący trzy parametry reprezentujące nr bandy,
-- nazwę bandy oraz teren polowań.
-- Skrypt ma uniemożliwiać wprowadzenie istniejących już wartości parametrów
-- poprzez obsługę odpowiednich wyjątków.
-- Sytuacją wyjątkową jest także wprowadzenie numeru bandy <=0.
-- W przypadku zaistnienia sytuacji wyjątkowej
-- należy wyprowadzić na ekran odpowiedni komunikat.
-- W przypadku prawidłowych parametrów należy stworzyć nową bandę
-- w relacji Bandy. Zmianę należy na końcu wycofać.
